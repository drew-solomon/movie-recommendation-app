...
|![Dash-app-example.png](https://i.postimg.cc/Xq6XrpH6/Dash-app-example.png=1000x2000)
|:--:|
...
|![Movie-trends-dashboard-example.jpg](https://i.postimg.cc/QddCKLbC/Movie-trends-dashboard-example.jpg=2000x1000)
|:--:|
